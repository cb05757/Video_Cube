...
public:
	...
	Cube(void);
	void Initalize(int cubeSize,LPCSTR szFile1,LPCSTR szFile2,LPCSTR szFile3,LPCSTR szFile4,LPCSTR szFile5,LPCSTR szFile6);
	void Initalize(int cubeSize,float newX,float newY,float newZ,LPCSTR szFile1,LPCSTR szFile2,LPCSTR szFile3,LPCSTR szFile4,LPCSTR szFile5,LPCSTR szFile6);
	void Draw();
